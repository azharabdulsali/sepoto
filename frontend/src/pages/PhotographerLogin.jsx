...
import { Camera, ArrowRight, Lock, Mail, Loader2, AlertCircle, Aperture, Sparkles } from 'lucide-react';
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
            className="relative w-16 h-16 rounded-2xl bg-[#191C21] border border-blue-500/30 flex items-center justify-center shadow-xl mb-3 cursor-pointer"
            onClick={() => navigate('/')}
          >
            <Aperture className="w-8 h-8 text-blue-400" strokeWidth={2} />
